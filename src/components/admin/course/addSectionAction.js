...
const SectionActions = ({ handleUploadVideo, handleAddSection }) => {

    return (
        <div className="section-actions">
            <button className="btn btn-section-secondary" onClick={handleUploadVideo}>
            ...
            <button className="btn btn-section-secondary" onClick={handleAddSection}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
