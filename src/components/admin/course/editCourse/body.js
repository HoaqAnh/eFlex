...
const Body = () => {
    ...
    const { courseData = {}, handleInputChange, handleImageSelect, handleRemoveImage, handleGetCourseDetails, imagePreview, selectedImage, formErrors, loading, error } = useCourse();
    ...
    }, [courseId, handleGetCourseDetails]);
