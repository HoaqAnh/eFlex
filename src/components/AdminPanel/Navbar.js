    ...
    <div className="navbar">
      ...
      <div className="navbar__actions">
        <button
          ...
          title="Trợ giúp"
        >
          <svg className="navbar__button-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        >
          <svg className="navbar__button-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M8 12a4 4 0 1 0 8 0a4 4 0 1 0-8 0m-5 0h1m8-9v1m8 8h1m-9 8v1M5.6 5.6l.7.7m12.1-.7l-.7.7m0 11.4l.7.7m-12.1-.7l-.7.7" />
          </svg>
        </button>
        <button
        ...
        <div className="navbar__user-container">
          <button
            ref={userBtnRef}
            className={`navbar__button ${activeButton === 'user' || showUserMenu ? 'navbar__button--active' : ''}`}
          ...
          {showUserMenu && (
            <div ref={userMenuRef} className="user-dropdown">
              <div className="user-dropdown__item" onClick={handleAccountClick}>
                <svg className="user-dropdown__item-icon" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
              ...
              <div className="user-dropdown__item user-dropdown__item--logout" onClick={handleLogoutClick}>
                <svg className="user-dropdown__item-icon" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
        ...
        <div className="modal">
          <div className="modal__content">
            ...
            <div className="modal__body">
              <p className="modal__text">Bạn có chắc chắn muốn đăng xuất khỏi hệ thống?</p>
            </div>
            <div className="modal__footer">
              <button className="modal__button modal__button--cancel" onClick={cancelLogout}>Hủy</button>
              <button className="modal__button modal__button--confirm" onClick={confirmLogout}>Đăng xuất</button>
            </div>
          </div>
        </div>
      )}
