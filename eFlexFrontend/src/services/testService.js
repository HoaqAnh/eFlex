...
export const getTests = async (lessonId) => {
  try {
    ...
    const response = await fetch(
      `${BASE_URL}/test-exercises/lesson/${lessonId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
// Submit Test
export const submitTest = async (userId, testData, type) => {
  try {
    const token = TokenService.getToken();
    if (!token) {
      console.error("Không tìm thấy token, người dùng chưa đăng nhập");
    ...
    if (type === "Test") {
      response = await fetch(`${BASE_URL}/submit-test/${userId}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
      ...
      response = await fetch(`${BASE_URL}/submit-assessment-test/${userId}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
...
export const getRandomTestExerciseByCourseId = async (courseId) => {
  try {
    ...
    const response = await fetch(
      `${BASE_URL}/test-exercises/assessmentTest/${courseId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
